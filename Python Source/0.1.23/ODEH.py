...
def build_chrome_options():
    ...
    if dominion_config()[5]:
        options.add_argument('--proxy-server=http://%s' % dominion_config()[7])

    if dominion_config()[4] == 0:
        options.add_argument("--headless")
    if int(dominion_config()[9]) == 1:
    ...
    options.add_argument('--user-agent=' + dominion_config()[6])
            ...
            try:
                ...
                try:
                    driver.find_element_by_xpath(
                        "/html/body/div/div/section/div[2]/div[1]/div/div[2]/table/tbody/tr/td[1]/form/button").click()
                except:
                    pass
            except IOError as e:
